...
class EfficientNetLite4(ClassificationModel):
    ...
    MODEL_URL = "https://github.com/PieterBlomme/proteus/raw/TRIT-92/packages/proteus_efficientnetlite4/proteus/models/efficientnetlite4/efficientnet-lite4-11.onnx"
